  ...
  getjymx: function(rwbh, ljbh) {
    ...
    qcloud.request({
      ...
      success(result) {
        ...
        var jymx = result.data.data.jymx[0];
        var jyxc = result.data.data.jyxc;
  ...
  getcslist: function(rwbh) {
    ...
    qcloud.request({
      ...
      success(result) {
        ...
        cslist = cslist.filter(c => jyxc.some(j => j.TC_TTS03 == c.TC_BMQ02));
